<?php
/**
 * Статистика переходов, регистраций, заказов за период по истонику, группировка по дням
 *
 * @param string       $source
...
<div id="sf_admin_container">
    ...
    <?php include_partial('filter', array('route' => 'sfAdStatStatDailySource', 'routeParams' => array('source' => $source), 'filter' => $filter)) ?>
